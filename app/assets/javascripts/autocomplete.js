...
(function (Modules) {
  ...
  function onAutocompleteSelectItem(e) {
    ...
    button.setAttribute('aria-controls', e.target.innerText);
    button.setAttribute('aria-label', 'Remove filter ' + e.target.innerText);
    ...
    var checkbox = document.querySelector("input[value='" + e.target.innerText + "']")
    if (checkbox) {
